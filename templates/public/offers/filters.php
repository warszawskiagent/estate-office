<?php
/**
 * Filters for public offers catalog.
 *
 * @var string            $base_url
 ...
 */
?>
<form method="get" action="<?php echo esc_url( $base_url ); ?>" class="estate-office-filters" data-eo-filters="offers">
    <div class="estate-office-filters__fields">
        <label class="estate-office-field">
            ...
            <select name="eo_offer_type" data-auto-submit="1">
        ...
        <div class="estate-office-field estate-office-filters__range" data-eo-price-range>
            ...
            <div class="estate-office-filters__range-inputs">
                <label>
                    ...
                    <input type="number" name="eo_offer_price_min" value="<?php echo esc_attr( $filters['price_min_raw'] ?? '' ); ?>" min="0" step="1000" data-filter-min />
                </label>
                <label>
                    <span class="screen-reader-text"><?php esc_html_e( 'Cena maksymalna', 'estate-office' ); ?></span>
                    <input type="number" name="eo_offer_price_max" value="<?php echo esc_attr( $filters['price_max_raw'] ?? '' ); ?>" min="0" step="1000" data-filter-max />
                </label>
            </div>
