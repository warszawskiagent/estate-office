...
?>
<div class="eocrm-wrap eocrm-public-wrap eocrm-offer-single-wrap eocrm-offer-template-v4">
    <header class="eocrm-offer-single-hero eocrm-offer-single-hero-v4">
        <div class="eocrm-offer-single-media eocrm-gallery-slider eocrm-gallery-style-thumbs" id="eocrm-offer-gallery" data-eocrm-gallery-slider data-eocrm-gallery-style="thumbs">
            ...
            <?php else : ?>
                ...
                <?php if (count($slider_photos) > 1) : ?>
                    ...
                    <div class="eocrm-gallery-dots eocrm-gallery-thumb-dots">
                        <?php foreach ($slider_photos as $index => $photo_url) : ?>
                            <button type="button" class="eocrm-gallery-dot eocrm-gallery-thumb-dot<?php echo $index === 0 ? ' is-active' : ''; ?>" data-eocrm-gallery-dot="<?php echo (int) $index; ?>" aria-label="Zdjecie <?php echo (int) ($index + 1); ?>" style="background-image:url('<?php echo esc_url($photo_url); ?>');"></button>
                        <?php endforeach; ?>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        ...
        <div class="eocrm-offer-single-summary">
    ...
    <section class="eocrm-card eocrm-offer-agent-card" id="eocrm-offer-contact">
        <h3>Agent - Opiekun oferty</h3>
        <div class="eocrm-offer-agent-columns">
            <div class="eocrm-offer-agent-col eocrm-offer-agent-col-profile">
            ...
            <div class="eocrm-offer-agent-col eocrm-offer-agent-col-form">
                <h4>Umow sie na wizyte</h4>
    ...
    <?php if (! empty($multimedia_items)) : ?>
        <section class="eocrm-card" id="eocrm-offer-multimedia">
            <h3>Multimedia</h3>
