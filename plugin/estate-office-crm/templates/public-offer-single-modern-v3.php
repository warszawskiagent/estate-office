...
<div class="eocrm-wrap eocrm-public-wrap eocrm-offer-single-wrap">
    <div class="eocrm-offer-v3-layout">
        <div class="eocrm-offer-v3-main">
            <section class="eocrm-offer-single-media eocrm-gallery-slider eocrm-gallery-16x9" data-eocrm-gallery-slider>
    ...
    <section class="eocrm-card">
        ...
        <aside class="eocrm-offer-v3-side">
