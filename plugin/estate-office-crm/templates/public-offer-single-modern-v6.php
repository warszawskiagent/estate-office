...
?>
<div class="eocrm-wrap eocrm-public-wrap eocrm-offer-single-wrap eocrm-offer-template-v6">
    <div class="eocrm-offer-v3-layout eocrm-offer-v6-layout">
        <div class="eocrm-offer-v3-main eocrm-offer-v6-main">
            <section class="eocrm-offer-single-media eocrm-gallery-slider eocrm-gallery-16x9 eocrm-gallery-style-progress" data-eocrm-gallery-slider data-eocrm-gallery-style="progress" data-eocrm-gallery-autoplay="1" data-eocrm-gallery-autoplay-interval="5200">
    ...
    <section class="eocrm-card">
        ...
        <aside class="eocrm-offer-v3-side eocrm-offer-v6-side">
            ...
            <section class="eocrm-card eocrm-offer-v3-agent">
            ...
            <section class="eocrm-card eocrm-offer-v3-contact" id="eocrm-offer-contact">
