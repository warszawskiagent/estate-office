...
## Status rozwoju (aktualizacja 0.8.0)
...
| Panel administratora – menu główne | Menu główne CRM i podstrony | 0.1.0 | 85% |
| Baza danych – tabele customowe | Tabele nieruchomości, klientów, umów, poszukiwań, agentów | 0.2.0 | 75% |
| Zarządzanie agentami | Profil agenta, rola i ograniczenia uprawnień | 0.3.0 | 65% |
| Ustawienia globalne | API Google, branding i dynamiczne pola | 0.3.0 | 60% |
| Moduł nieruchomości | CRUD nieruchomości, galerie, znaczniki, eksport WWW | 0.4.0 | 65% |
| Moduł poszukiwań | CRUD poszukiwań klientów | 0.5.0 | 60% |
| Moduł umów | Proces dodawania i etapy umowy | 0.6.0 | 60% |
| Moduł klientów | Profil klienta i powiązania danych | 0.6.0 | 60% |
| Dashboard CRM | Pulpit podsumowań i wskaźników | 0.7.0 | 70% |
| Frontend CRM (po zalogowaniu) | Widoki list i szczegółów dla użytkowników | 0.7.0 | 65% |
| Publiczne oferty nieruchomości | Strony ofert z kategoryzacją | 0.8.0 | 70% |
...
- **Wersja 0.8.0 (bieżąca)**: Publiczne strony ofert z filtrowaniem i widokiem szczegółowym.
...
- **Wprowadzone w tej wersji (0.8.0)**: automatyczne tworzenie publicznych stron „Oferty na sprzedaż” i „Oferty na wynajem” z filtrowaniem według typu transakcji, typu nieruchomości, miasta i dzielnicy, widokiem kart ofert, paginacją oraz sekcją szczegółów ze zdjęciami.
...
- **Następne kroki**: rozwój systemu licencyjnego i integracji eksportu na portale (0.9.0) oraz przygotowanie kalkulatorów finansowych (1.0.0).
