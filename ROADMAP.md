...
## Status rozwoju (aktualizacja 0.7.0)
...
- **Wersja 0.7.0 (bieżąca)**: Dashboard CRM i frontend po zalogowaniu.
...
- **Wprowadzone w tej wersji (0.7.0)**: interaktywny pulpit administratora z metrykami, rankingiem agentów i historią etapów oraz portal frontendowy CRM dla zalogowanych użytkowników z zakładkami (pulpit, nieruchomości, poszukiwania, umowy, klienci) i widokami szczegółowymi.
...
- **Następne kroki**: przygotowanie dashboardu CRM i widoków frontowych (0.7.0) oraz dalsza integracja procesów (powiązania nieruchomości/poszukiwań z etapami umów).
