...
== Changelog ==
= 0.8.0 =
* Dodano integrację z Mapami Google w kreatorze nieruchomości wraz z wyszukiwarką adresów i automatycznym uzupełnianiem pól.
* Zapisywanie współrzędnych, adresu oraz informacji o księdze wieczystej w profilach nieruchomości.
* Wzbogacono profil nieruchomości i publiczne oferty o interaktywne mapy z lokalizacją i komunikatami awaryjnymi.
