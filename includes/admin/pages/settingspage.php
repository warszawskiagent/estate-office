...
final class SettingsPage extends BasePage
{
    ...
    public static function enqueueAssets(): void
    {
        ...
        if ($screenId === 'estate-office-crm_page_estate-office-settings') {
            wp_enqueue_media();
            wp_enqueue_script(
        ...
        if (in_array($screenId, ['estate-office-crm_page_estate-office-settings', 'estate-office-crm_page_estate-office-license'], true)) {
            wp_enqueue_style(
                'estate-office-settings',
