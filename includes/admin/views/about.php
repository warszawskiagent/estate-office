...
?>
<div class="wrap estate-office-about">
    <h1><?php esc_html_e( 'O wtyczce Estate Office', 'estate-office' ); ?></h1>
    <p><?php esc_html_e( 'Estate Office to kompleksowe rozwiązanie CRM dla biur nieruchomości. Wersja 0.0.1 dostarcza bazową strukturę danych, menu administracyjne oraz panel zarządzania agentami.', 'estate-office' ); ?></p>
